...
Tests Reddit API, MongoDB, and all core components
"""
...
def test_stock_fetcher():
    ...
    print("\n" + "="*70)
    print("TEST 6: Stock Data Fetcher")
    print("="*70 + "\n")

    try:
        from stock_data_fetcher import StockDataFetcher

        print("Initializing stock data fetcher...")
        fetcher = StockDataFetcher()

        print("✓ Stock fetcher initialized")
        ...
        print(f"✗ Stock fetcher test failed: {e}")
        print()
        import traceback
        traceback.print_exc()
        print()
...
def run_all_tests():
    ...
    print("\n")
    print("#"*70)
    print("# REDDIT TRADING BOT - COMPREHENSIVE SETUP TEST")
    print("#"*70)
    ...
    tests = [
        ...
        ("Stock Fetcher", test_stock_fetcher),
    ]
    ...
    if passed == total:
        print("\n🎉 All tests passed! Your setup is complete and ready to use!")
        print("\nNext steps:")
        print("  1. python main.py --mode full")
        print("  2. Check logs/trading_bot.log for output")
        print("  3. View results in MongoDB")
    else:
